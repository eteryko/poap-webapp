...
const SecretList: FC<WebsitesListProps> = ({ onCreateNew, onEdit }) => {
  /* State */
  ...
  const [secrets, setSecrets] = useState<Website[]>([]);
  ...
  useEffect(() => {
    if (secrets.length > 0) fetchWebsites().then();
